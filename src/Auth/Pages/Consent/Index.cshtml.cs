...
namespace Auth.Pages.Consent
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(
            IIdentityServerInteractionService interaction,  IClientStore clientStore,  IResourceStore resourceStore,
            IEventService events, ILogger<IndexModel> logger)
        {
        ...
        private async Task<ConsentViewModel> BuildViewModelAsync(string returnUrl, ConsentInputModel model = null)
        {
            ...
            if (request != null)
            {
                ...
                if (client != null)
                {
                    ...
                    _logger.LogError(
                        "No scopes matching: {0}", request.ScopesRequested.Aggregate((x, y) => $"{x}, {y}"));
                }
                else
                {
